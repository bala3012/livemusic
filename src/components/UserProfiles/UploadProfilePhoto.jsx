...
const UploadProfilePhoto = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append("upload_preset", "live_music"); //! Add the upload preset
      data.append("cloud_name", "ddeluvk3i"); //! Add the Cloudinary cloud name

      //! Connect Cloudinary API and Send File => window.fetch();
      const response = await fetch(
        `https://api.cloudinary.com/v1_1/ddeluvk3i/image/upload`,
        {
          method: "POST",
          body: data,
        }
